...
{
    // Dev
    $to_email       = "tony@gritdigital.com"; //Recipient email, Replace with own email here
    ...
    $company        = filter_var($_POST["comapny"], FILTER_SANITIZE_STRING);
    ...
    //email subject
    $subject = "EastPort Website Enquiry from ".$user_name;
    ...
    if(!$send_mail)
    {
        ...
        $output = json_encode(array('type'=>'message', 'text' => '<span>'.$user_name .'</span>. Thank you for your email. We will be in touch shortly.'));
        die($output);
    }
}
?>
